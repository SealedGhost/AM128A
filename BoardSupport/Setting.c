...
//         }      
//         else if(pIterator->pBerth->Boat.dist >= 99999)
//         {
...
//INFO("snap miss %09ld", pIterator->mntBoat.mmsi);                  
         return ;
      }
      else
      {
...
//if(pBerth->mntState == MNTState_Monitored)   
//INFO("snap null");
}
